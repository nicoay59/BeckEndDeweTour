...
function CardPaymentWait() {

    const {puantiti, price} = useParams();

    const [state, dispatch] = useContext(UserContext)
    console.log(state, "paymentwait");
    ...
    // console.log(transactions, "iniditest dulu");
    // console.log(state, 'ini state trans', transactions[transactions.length - 1 ].counter_qty);
...
export default CardPaymentWait